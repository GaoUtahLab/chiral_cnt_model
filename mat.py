...
def chiral_molecules(exp_wl, env_eps, const_kappa):
    ...
    '''computation of a constant dielectric constants and chiral parameter for chiral molecules

    Parameters
    ----------
    'exp_wl' = wavelength range (um)
    'env_eps' = environmental dielectric constant (number, unit 1)
    'const_kappa' = constant chiral parameter (number, unit 1)

    Returns
    -------
    'eps' = a constant dielectric function vector
    'kappa' = a constant chiral parameter vector

    Extension to anisotropic chiral molecules 
    ------------------------------------------
    This function can be extended to include dispersive chiral parameters for chiral molecules 
    by adding a one-resonance Condon model for diagonal elements. The chirality parameter is 
    assumed to be anisotropic and rotation transformation is similar to anisotropic CNT 
    dielectric function. 
    '''
